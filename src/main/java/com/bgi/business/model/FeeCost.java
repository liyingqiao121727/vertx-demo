 ...
 * @since 2019-09-05
 */
public class FeeCost extends BaseModel {

    private static final long serialVersionUID = 1L;

    public static final String TABLE = "fee_cost";
    ...
    static {
        FeeCost.map.putAll(BaseModel.map);
    }
    ...
    public FeeCost(JsonObject jsonObject) {
    ...
    public FeeCost(JsonObject jsonObject, boolean init) {
    ...
    public static Map<String, FeeCost> result2NameMap(ResultSet result) {
        ...
        Map<String, FeeCost> map = new HashMap<>(result.getNumRows());
        List<JsonArray> list = result.getResults();
        JsonObject jsonObject = null;
        FeeCost glodonCost = null;
        for (JsonArray jsonArray : list) {
            jsonObject = new JsonObject();
            for (int j = 0; j < jsonArray.size(); j++) {
                jsonObject.put(cols[j], jsonArray.getValue(j));
            }
            glodonCost = new FeeCost(jsonObject);
    ...
    public void setProjId(String projId) {
        this.entries.put(FeeCost.projId, projId);
    }

    public void setOrderNo(String orderNo) {
        this.entries.put(FeeCost.orderNo, orderNo);
    }

    public void setName(String name) {
        this.entries.put(FeeCost.name, name);
    }

    public void setParams(String params) {
        this.entries.put(FeeCost.params, params);
    }

    public void setStandard(String standard) {
        this.entries.put(FeeCost.standard, standard);
    }

    public void setUnit(String unit) {
        this.entries.put(FeeCost.unit, unit);
    }

    public void setTotalAmount(String totalAmount) {
        this.entries.put(FeeCost.totalAmount, totalAmount);
    }

    public void setTotalUnitPrice(String totalUnitPrice) {
        this.entries.put(FeeCost.totalUnitPrice, totalUnitPrice);
    }

    public void setTotalMoney(String totalMoney) {
        this.entries.put(FeeCost.totalMoney, totalMoney);
    }

    public void setTargetAmount(String targetAmount) {
        this.entries.put(FeeCost.targetAmount, targetAmount);
    }

    public void setTargetUnitPrice(String targetUnitPrice) {
        this.entries.put(FeeCost.targetUnitPrice, targetUnitPrice);
    }

    public void setTargetMoney(String targetMoney) {
        this.entries.put(FeeCost.targetMoney, targetMoney);
    }

    public void setRemark(String remark) {
        this.entries.put(FeeCost.remark, remark);
    }

    public void setAlias(String alias) {
        this.entries.put(FeeCost.alias, alias);
    }

    public void setAliasNo(String aliasNo) {
        this.entries.put(FeeCost.aliasNo, aliasNo);
    }

    public void setType(Integer type) {
        this.entries.put(FeeCost.type, type);
    }

    public void setSettleAmount(String settleAmount) {
        this.entries.put(FeeCost.settleAmount, settleAmount);
    }

    public void setSettleUnitPrice(String settleUnitPrice) {
        this.entries.put(FeeCost.settleUnitPrice, settleUnitPrice);
    }

    public void setSettleMoney(String settleMoney) {
        this.entries.put(FeeCost.settleMoney, settleMoney);
    }

    public void setRowNo(Long rowNo) {
        entries.put(FeeCost.rowNo, rowNo);
    }
    ...
    public void setActualAmount(String actualAmount) {
        entries.put(FeeCost.actualAmount, actualAmount);
    }

    public void setActualUnitPrice(String actualUnitPrice) {
        entries.put(FeeCost.actualUnitPrice, actualUnitPrice);
    }

    public void setActualMoney(String actualMoney) {
        entries.put(FeeCost.actualMoney, actualMoney);
    }
}
