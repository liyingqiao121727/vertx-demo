...
import com.bgi.business.model.mis.BigAgreement;
import com.bgi.business.model.mis.EarthEnergyUser;
import com.bgi.business.model.mis.SubpackageAgreement;
import com.bgi.business.model.mis.SubpackagePay;
...
public class Project extends BaseModel implements QueryPage {
    ...
    public static String getOne(String id, JsonArray params) {
        params.add(id);
        return " select " + columnListJoinA() + " , b.fie_con_no as agreementNo, b.fie_con_manager as cmo, " +
                ...
                com.bgi.business.model.mis.BigAgreement.TABLE + " b on b.for_foreig_key = a.id left join " + com.bgi.business.model.mis.EarthEnergyUser.TABLE +
                " u1 on u1.id = b.fie_con_manager left join " + com.bgi.business.model.mis.EarthEnergyUser.TABLE +
    ...
    public static String getOneSimple(String id, JsonArray params) {
        ...
        return " select " + columnListJoinASimple() + " , b.fie_con_no as agreementNo, b.salesman as cmo " +
                ...
                Constant.EARTH_ENERGY_DEPT_IDS + ") a left join " +
                com.bgi.business.model.mis.BigAgreement.TABLE + " b on b.for_foreig_key = a.id ; ";
    }
    ...
    public static String getProjByIdIn(int size) {
        StringBuilder sb = new StringBuilder(" select ").append(columnListJoinASimple()).append(" from ")
    ...
    public String queryPage(SQLpage sqLpage, JsonArray params) {
        ...
        sb.append(" , d.id as bigAgreeId, " +
                " d.fie_con_no as agreeNo, d.fie_contra_name as bigAgreeName, " +
                " a.fie_engine_amt as bigAgreeMoney, a.fie_engine_final_amt as bigAgreeFinalMoney ");  //_final
        ...
        sb.append(" left join ( select * from ").append(com.bgi.business.model.mis.BigAgreement.TABLE).append(" where del_flag = 0 ");
    ...
    public String queryPage1(SQLpage sqLpage, JsonArray params) {
        ...
        sb.append(" inner join ( select project_id as cpid, id as bigAgreeId, money as bigAgreeMoney from ")
                .append(com.bgi.business.model.mis.BigAgreement.TABLE).append(" where  del_flag = 0 ");
    ...
    public String list(JsonArray params) {
        String sql = " select " + columnListJoinASimple() + " from ( select * from " + TABLE +
                " where del_flag = 0 and fie_impl_dept in " + Constant.EARTH_ENERGY_DEPT_IDS;
        StringBuilder sb = new StringBuilder(sql);
        if (null != this.getName() && !"".equals(this.getName().trim())) {
