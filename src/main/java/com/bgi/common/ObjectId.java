...
public class ObjectId implements Comparable<ObjectId>, java.io.Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return this.serialVersionUID == that.serialVersionUID &&
                this._time == that._time &&
                this._machine == that._machine &&
                this._inc == that._inc &&
                this._new == that._new &&
                this._nextInc.equals(that._nextInc) &&
                this._genmachine == that._genmachine;
    }

    @Override
    public int hashCode() {
        return Objects.hash(serialVersionUID, _time, _machine, _inc, _new,
